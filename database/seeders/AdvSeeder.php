...
class AdvSeeder extends Seeder
{
    public function run()
    {
        DB::table('advs')->insert([
            [
                'date_of_adv' => '2025-07-15',
                'photo' => 'advs/summer-workshop.jpg',
            ...
            [
                'date_of_adv' => '2025-07-10',
                'photo' => 'advs/scholarship-program.jpg',
            ...
            [
                'date_of_adv' => '2025-07-05',
                'photo' => 'advs/partnership-announcement.jpg',
