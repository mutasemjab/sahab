...
@section('title', __('messages.create') . ' ' . __('messages.Advs'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.create') }} {{ __('messages.Advs') }}</h1>
        ...
        <form action="{{ route('advs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('date_of_adv') is-invalid @enderror" 
                       id="date_of_adv" name="date_of_adv" value="{{ old('date_of_adv') }}" required>
                @error('date_of_adv')
