                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_en') is-invalid @enderror" 
                                  id="description_en" name="description_en" rows="5" required>{{ old('description_en', $banner->description_en) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_ar') is-invalid @enderror" 
                                  id="description_ar" name="description_ar" rows="5" required>{{ old('description_ar', $banner->description_ar) }}</textarea>
