...
@section('title', __('messages.create') . ' ' . __('messages.complete_abouts'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.create') }} {{ __('messages.complete_abouts') }}</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('complete_abouts.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
