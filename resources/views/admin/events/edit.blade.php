...
@section('title', __('messages.edit') . ' ' . __('messages.Events'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.edit') }} {{ __('messages.Events') }}</h1>
        ...
        <form action="{{ route('events.update', $event->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('date_of_event') is-invalid @enderror" 
                       id="date_of_event" name="date_of_event" value="{{ old('date_of_event', $event->date_of_event) }}" required>
                @error('date_of_event')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" 
                               id="title_en" name="title_en" value="{{ old('title_en', $event->title_en) }}" required>
                        @error('title_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control @error('link_google_meet') is-invalid @enderror" 
                       id="link_google_meet" name="link_google_meet" value="{{ old('link_google_meet', $event->link_google_meet) }}" 
