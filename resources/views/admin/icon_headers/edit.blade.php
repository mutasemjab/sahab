        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('messages.edit_icon_header') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('icon_headers.update', $iconHeader) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" 
                                       ...
                                       id="link" 
                                       name="link" 
                                       value="{{ old('link', $iconHeader->link) }}"
