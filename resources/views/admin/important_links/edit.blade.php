...
@section('title', __('messages.edit') . ' ' . __('messages.ImportantLinks'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.edit') }} {{ __('messages.ImportantLinks') }}</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('important-links.update', $importantLink->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" 
                               id="title_en" name="title_en" value="{{ old('title_en', $importantLink->title_en) }}" required>
                        @error('title_en')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title_ar') is-invalid @enderror" 
                               id="title_ar" name="title_ar" value="{{ old('title_ar', $importantLink->title_ar) }}" required>
                        @error('title_ar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                               id="icon" name="icon" value="{{ old('icon', $importantLink->icon) }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('link') is-invalid @enderror" 
                               id="link" name="link" value="{{ old('link', $importantLink->link) }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_en') is-invalid @enderror" 
                                  id="description_en" name="description_en" rows="5" required>{{ old('description_en', $importantLink->description_en) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_ar') is-invalid @enderror" 
                                  id="description_ar" name="description_ar" rows="5" required>{{ old('description_ar', $importantLink->description_ar) }}</textarea>
