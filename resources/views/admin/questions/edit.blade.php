...
@section('title', __('messages.edit') . ' ' . __('messages.Questions'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.edit') }} {{ __('messages.Questions') }}</h1>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('question_en') is-invalid @enderror" 
                               id="question_en" name="question_en" value="{{ old('question_en', $question->question_en) }}" required>
                        @error('question_en')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('question_ar') is-invalid @enderror" 
                               id="question_ar" name="question_ar" value="{{ old('question_ar', $question->question_ar) }}" required>
                        @error('question_ar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('answer_en') is-invalid @enderror" 
                                  id="answer_en" name="answer_en" rows="5" required>{{ old('answer_en', $question->answer_en) }}</textarea>
                        @error('answer_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('answer_ar') is-invalid @enderror" 
                                  id="answer_ar" name="answer_ar" rows="5" required>{{ old('answer_ar', $question->answer_ar) }}</textarea>
                        @error('answer_ar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
