...
@section('title', __('messages.edit') . ' ' . __('messages.Services'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.edit') }} {{ __('messages.Services') }}</h1>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_en') is-invalid @enderror" 
                                  id="description_en" name="description_en" rows="5" required>{{ old('description_en', $service->description_en) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_ar') is-invalid @enderror" 
                                  id="description_ar" name="description_ar" rows="5" required>{{ old('description_ar', $service->description_ar) }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        @if($service->pdf)
                            <div class="mb-2">
                                <a href="{{ asset('assets/admin/uploads/' . $service->pdf) }}" target="_blank" class="btn btn-sm btn-info">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('target_audience') is-invalid @enderror" 
                               id="target_audience" name="target_audience" value="{{ old('target_audience', $service->target_audience) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('duration_service') is-invalid @enderror" 
                               id="duration_service" name="duration_service" value="{{ old('duration_service', $service->duration_service) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('service_channel') is-invalid @enderror" 
                               id="service_channel" name="service_channel" value="{{ old('service_channel', $service->service_channel) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('service_cost') is-invalid @enderror" 
                               id="service_cost" name="service_cost" value="{{ old('service_cost', $service->service_cost) }}" required>
                        @error('service_cost')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
