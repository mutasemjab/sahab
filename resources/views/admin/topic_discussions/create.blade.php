...
@section('title', __('messages.create') . ' ' . __('messages.TopicDiscussions'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.create') }} {{ __('messages.TopicDiscussions') }}</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('topic-discussions.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_en') is-invalid @enderror" 
                                  id="description_en" name="description_en" rows="8" required>{{ old('description_en') }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rich-text @error('description_ar') is-invalid @enderror" 
                                  id="description_ar" name="description_ar" rows="8" required>{{ old('description_ar') }}</textarea>
