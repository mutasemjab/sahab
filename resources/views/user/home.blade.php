 ...
 @section('content')
     <section class="hero-slider">
         <div class="slides">
             @foreach ($bannersTop as $index => $banner)
     ...
     <div class="two-col-wrap">
         ...
         <section class="news-section">
             ...
             <div class="news-grid">
                 @foreach ($advs as $adv)
                     <div class="news-card">
                         <img src="{{ asset('assets/admin/uploads/' . $adv->photo) }}"
                             alt="{{ $adv->{'title_' . $locale} }}">
                         <div class="news-content">
                             <span class="news-date">
                                 {{ \Carbon\Carbon::parse($adv->date_of_adv)->locale('ar')->translatedFormat('j F Y') }}</span>
     ...
     <section class="sessions-section">
       ...
       <section class="hero-slider">
         <div class="slides">
             @foreach ($bannersDown as $index => $banner)
                 <div class="slide {{ $index == 0 ? 'active' : '' }}"
                     style="background-image: url('{{ asset('assets/admin/uploads/' . $banner->photo) }}');">
                     <div class="slide-content">
                         <h2>{{ $banner->{'title_' . $locale} }}</h2>
