<header class="header-container">
    ...
    <div class="header-menu">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <a href="{{ route('projects') }}"
                    class="{{ request()->routeIs('projects') ? 'active' : '' }}">المشاريع</a>
            </div>
        </div>
        ...
        <a href="{{ route('wbsiteTenders.index') }}"
            class="{{ request()->routeIs('wbsiteTenders.index') ? 'active' : '' }}">
            {{ __('front.Tenders') }}
        </a>
       
          <a href="{{ route('community.index') }}"
            class="{{ request()->routeIs('community.index') ? 'active' : '' }}">تفاصيل المجتمع</a>

       

        <div class="dropdown">
            <a href="{{ route('complaints.index') }}"
                class="{{ request()->routeIs('complaints.index', 'complaintdetails', 'complaintfollow') ? 'active' : '' }}">
                {{ __('front.complaints') }} <i class="fas fa-chevron-down"></i>
            </a>
            <div class="dropdown-menu">
                <a href="{{ route('complaints.index') }}"
                    class="{{ request()->routeIs('complaints.index') ? 'active' : '' }}">تقديم شكوى</a>
                <a href="{{ route('complaintdetails') }}"
                    class="{{ request()->routeIs('complaintdetails') ? 'active' : '' }}">تفاصيل الشكوى</a>
                <a href="{{ route('complaintfollow') }}"
                    class="{{ request()->routeIs('complaintfollow') ? 'active' : '' }}">تتبع شكواك</a>
            </div>
        </div>
