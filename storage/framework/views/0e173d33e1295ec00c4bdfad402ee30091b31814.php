        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('messages.add_service_details')); ?> - <?php echo e($service->title_en); ?></h3>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('services.details.store', $service->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="description_en" 
                                              rows="4" 
                                              placeholder="<?php echo e(__('messages.description_en_placeholder')); ?>"><?php echo e(old('description_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="description_ar" 
                                              rows="4" 
                                              placeholder="<?php echo e(__('messages.description_ar_placeholder')); ?>"><?php echo e(old('description_ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="steps" 
                                              rows="4" 
                                              placeholder="<?php echo e(__('messages.steps_placeholder')); ?>"><?php echo e(old('steps')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="condition" 
                                              rows="4" 
                                              placeholder="<?php echo e(__('messages.condition_placeholder')); ?>"><?php echo e(old('condition')); ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control rich-text  <?php $__errorArgs = ['required_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="required_file" 
                                              rows="3" 
                                              placeholder="<?php echo e(__('messages.required_file_placeholder')); ?>"><?php echo e(old('required_file')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/services/create-details.blade.php ENDPATH**/ ?>