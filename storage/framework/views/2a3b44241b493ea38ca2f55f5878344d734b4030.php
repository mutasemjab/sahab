<?php $__env->startSection('title', __('messages.edit') . ' ' . __('messages.About')); ?>
...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('complete_abouts.update', $completeAbout->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               id="title_en" name="title_en" value="<?php echo e(old('title_en', $completeAbout->title_en)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="title_ar" name="title_ar" value="<?php echo e(old('title_ar', $completeAbout->title_ar)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_en" name="description_en" rows="8" required><?php echo e(old('description_en', $completeAbout->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_ar" name="description_ar" rows="8" required><?php echo e(old('description_ar', $completeAbout->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                               id="icon" name="icon" value="<?php echo e(old('icon', $completeAbout->icon)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-end">
                <a href="<?php echo e(route('complete_abouts.index')); ?>" class="btn btn-secondary me-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/complete_abouts/edit.blade.php ENDPATH**/ ?>