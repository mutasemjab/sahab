<?php $__env->startSection('title', __('messages.edit') . ' ' . __('messages.Banners')); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><?php echo e(__('messages.edit')); ?> <?php echo e(__('messages.Banners')); ?></h1>
...
unset($__errorArgs, $__bag); ?>" 
                               id="title_en" name="title_en" value="<?php echo e(old('title_en', $banner->title_en)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="title_ar" name="title_ar" value="<?php echo e(old('title_ar', $banner->title_ar)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_en" name="description_en" rows="5" required><?php echo e(old('description_en', $banner->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_ar" name="description_ar" rows="5" required><?php echo e(old('description_ar', $banner->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <?php if($banner->photo): ?>
                    <div class="mb-2">
                        <img src="<?php echo e(asset('assets/admin/uploads/' . $banner->photo)); ?>" alt="Current Photo" class="img-thumbnail" style="max-height: 200px;">
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/banners/edit.blade.php ENDPATH**/ ?>