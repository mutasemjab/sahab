<?php $__env->startSection('title', __('messages.create') . ' ' . __('messages.Services')); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><?php echo e(__('messages.create')); ?> <?php echo e(__('messages.Services')); ?></h1>
...
unset($__errorArgs, $__bag); ?>" 
                               id="target_audience" name="target_audience" value="<?php echo e(old('target_audience')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="duration_service" name="duration_service" value="<?php echo e(old('duration_service')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="service_channel" name="service_channel" value="<?php echo e(old('service_channel')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="service_cost" name="service_cost" value="<?php echo e(old('service_cost')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/services/create.blade.php ENDPATH**/ ?>