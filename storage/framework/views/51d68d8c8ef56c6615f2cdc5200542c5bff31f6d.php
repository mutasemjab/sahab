<?php $__env->startSection('title', __('messages.edit') . ' ' . __('messages.Projects')); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><?php echo e(__('messages.edit')); ?> <?php echo e(__('messages.Projects')); ?></h1>
...
unset($__errorArgs, $__bag); ?>" 
                               id="title_en" name="title_en" value="<?php echo e(old('title_en', $project->title_en)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="title_ar" name="title_ar" value="<?php echo e(old('title_ar', $project->title_ar)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_en" name="description_en" rows="5" required><?php echo e(old('description_en', $project->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_ar" name="description_ar" rows="5" required><?php echo e(old('description_ar', $project->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                            ...
                            <option value="1" <?php echo e(old('type', $project->type) == '1' ? 'selected' : ''); ?>><?php echo e(__('messages.done')); ?></option>
                            <option value="2" <?php echo e(old('type', $project->type) == '2' ? 'selected' : ''); ?>><?php echo e(__('messages.on_going')); ?></option>
                            <option value="3" <?php echo e(old('type', $project->type) == '3' ? 'selected' : ''); ?>><?php echo e(__('messages.planned')); ?></option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                               id="time" name="time" value="<?php echo e(old('time', $project->time)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <?php if($project->photo): ?>
                    <div class="mb-2">
                        <img src="<?php echo e(asset('assets/admin/uploads/' . $project->photo)); ?>" alt="Current Photo" class="img-thumbnail" style="max-height: 200px;">
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/projects/edit.blade.php ENDPATH**/ ?>