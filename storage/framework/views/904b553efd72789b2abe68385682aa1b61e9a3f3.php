<?php $__env->startSection('title', __('messages.create') . ' ' . __('messages.ImportantLinks')); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><?php echo e(__('messages.create')); ?> <?php echo e(__('messages.ImportantLinks')); ?></h1>
...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('important-links.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/important_links/create.blade.php ENDPATH**/ ?>