<?php $__env->startSection('title', __('messages.add_new_session')); ?>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4><?php echo e(__('messages.add_new_session')); ?></h4>
                </div>
                
                <div class="card-body">
                    <form action="<?php echo e(route('new-listen-sessions.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="title_ar" name="title_ar" value="<?php echo e(old('title_ar')); ?>" required dir="rtl">
...
unset($__errorArgs, $__bag); ?>" 
                                      id="description_ar" name="description_ar" rows="4" required dir="rtl"><?php echo e(old('description_ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('new-listen-sessions.index')); ?>" class="btn btn-secondary">
                                <?php echo e(__('messages.back')); ?>

                            </a>
                            <button type="submit" class="btn btn-success">
                                <?php echo e(__('messages.create_session')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/new_listen_sessions/create.blade.php ENDPATH**/ ?>