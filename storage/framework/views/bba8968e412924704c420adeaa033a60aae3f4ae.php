 ...
 <?php $__env->startSection('content'); ?>
     <section class="hero-slider">
         <div class="slides">
             <?php $__currentLoopData = $bannersTop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <section class="news-section">
             ...
             <div class="news-grid">
                 <?php $__currentLoopData = $advs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <div class="news-card">
                         <img src="<?php echo e(asset('assets/admin/uploads/' . $adv->photo)); ?>"
                             alt="<?php echo e($adv->{'title_' . $locale}); ?>">
                         <div class="news-content">
                             <span class="news-date">
                                 <?php echo e(\Carbon\Carbon::parse($adv->date_of_adv)->locale('ar')->translatedFormat('j F Y')); ?></span>
                             <h3><?php echo e($adv->{'title_' . $locale}); ?></h3>
                             <p><?php echo Str::limit($adv->{'description_' . $locale}, 60); ?>...</p>
                             <a href="<?php echo e(route('advertisement.show', $adv->id)); ?>" class="news-link">
     ...
     <section class="projects-section">
         <h2 class="section-title"><?php echo e($locale == 'ar' ? 'العطاءات' : 'Tenders'); ?></h2>
             ...
             <?php $__currentLoopData = $tenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <div class="project-card">
                     <div class="project-image">
                         <img src="<?php echo e(asset('assets/admin/uploads/' . $tender->photo)); ?>"
                             alt="<?php echo e($tender->{'title_' . $locale}); ?>">

                     </div>
                     <div class="project-content">
                         <h3><?php echo e($tender->{'title_' . $locale}); ?></h3>
                         <p><?php echo $tender->{'description_' . $locale}; ?></p>
                         <?php if($tender->date_publish): ?>
                             <p class="start-date"><?php echo e($locale == 'ar' ? ' تاريخ النشر:' : 'Publish from:'); ?>

                                 <?php echo e($tender->date_publish); ?></p>
                         <?php endif; ?>
                         <a href="<?php echo e(route('wbsiteTenders.show', $tender->id)); ?>" class="project-link">
     ...
     <section class="sessions-section">
       ...
       <section class="hero-slider">
         <div class="slides">
             <?php $__currentLoopData = $bannersDown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <div class="slide <?php echo e($index == 0 ? 'active' : ''); ?>"
                     style="background-image: url('<?php echo e(asset('assets/admin/uploads/' . $banner->photo)); ?>');">
                     <div class="slide-content">
                         <h2><?php echo e($banner->{'title_' . $locale}); ?></h2>
