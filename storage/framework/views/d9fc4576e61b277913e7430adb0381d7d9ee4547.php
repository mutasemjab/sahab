<?php $__env->startSection('title', __('messages.create') . ' ' . __('messages.TopicDiscussions')); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><?php echo e(__('messages.create')); ?> <?php echo e(__('messages.TopicDiscussions')); ?></h1>
    <a href="<?php echo e(route('topic-discussions.index')); ?>" class="btn btn-secondary">
...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('topic-discussions.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_en" name="description_en" rows="8" required><?php echo e(old('description_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description_ar" name="description_ar" rows="8" required><?php echo e(old('description_ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-end">
                <a href="<?php echo e(route('topic-discussions.index')); ?>" class="btn btn-secondary me-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahab\resources\views/admin/topic_discussions/create.blade.php ENDPATH**/ ?>