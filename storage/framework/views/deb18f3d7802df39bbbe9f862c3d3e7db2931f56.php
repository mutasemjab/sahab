                        ...
                        <tbody>
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('services.details', $service->id)); ?>" class="btn btn-info btn-sm"
                                            title="<?php echo e(__('messages.view_details')); ?>">
                                            <i class="fas fa-list"></i> <?php echo e(__('messages.details')); ?>

                                        </a>

                                        <!-- Add Details Button -->
                                        <a href="<?php echo e(route('services.details.create', $service->id)); ?>"
                                            class="btn btn-success btn-sm" title="<?php echo e(__('messages.add_details')); ?>">
