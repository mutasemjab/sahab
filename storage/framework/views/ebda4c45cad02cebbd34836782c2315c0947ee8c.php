  ...
  <div class="projects-grid">
    ...
    <div class="project-card">
      <div class="project-image">
        ...
        <span class="project-tag"><?php echo e(__('front.planned')); ?></span>
      </div>
      <div class="project-content">
        <h3><?php echo e($advertisement->title); ?></h3>
        <p><?php echo e(Str::limit($advertisement->description, 100)); ?></p>
        <p class="start-date"><?php echo e(__('front.starting_from')); ?>: <?php echo e($advertisement->formatted_date); ?></p>
        <a href="<?php echo e(route('advertisements.show', $advertisement->id)); ?>" class="project-link">
          <i class="fas fa-arrow-left"></i> <?php echo e(__('front.learn_more')); ?>
  ...
  <div class="news-grid">
    ...
    <div class="news-card">
      ...
      <div class="news-content">
        ...
        <a href="<?php echo e(route('news.show', $newsItem->id)); ?>" class="news-link">
          <i class="fas fa-arrow-left"></i> <?php echo e(__('front.read_more')); ?>
